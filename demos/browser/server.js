    ...
    http.createServer({}, async (request, response) => {
        ...
        try {
            ...
            if (request.method === 'GET' && requestUrl.pathname === '/') {
                ...
                if (!requestUrl.query.name || !requestUrl.query.region
                    || !requestUrl.query.meetingId) {
                    throw new Error('Need parameters: user name, region, meetingId');
                }

                if (!meetingTable[requestUrl.query.meetingId]) {
                    try {
                ...
                console.log('===start delete meeting : ', meetingTable[requestUrl.query.meetingId].Meeting.MeetingId)
